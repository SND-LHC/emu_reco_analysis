...
pos[0].append([0,      53000,  0,      53000,  -29627, 0])
pos[0].append([53000,  96000,  0,      53000,  -29627, 0])
pos[0].append([0,      53000,  53000,  96000,  -29627, 0])
pos[0].append([53000,  96000,  53000,  96000,  -29627, 0])
pos[1].append([96000,  138000, 0,      53000,  -29627, 0])
pos[1].append([138000, 200000, 0,      53000,  -29627, 0])
pos[1].append([96000,  138000, 53000,  96000,  -29627, 0])
pos[1].append([138000, 200000, 53000,  96000,  -29627, 0])
pos[2].append([0,      53000,  96000,  138000, -29627, 0])
pos[2].append([53000,  96000,  96000,  138000, -29627, 0])
pos[2].append([0,      53000,  138000, 200000, -29627, 0])
pos[2].append([53000,  96000,  138000, 200000, -29627, 0])
pos[3].append([96000,  138000, 96000,  138000, -29627, 0])
pos[3].append([138000, 200000, 96000,  138000, -29627, 0])
pos[3].append([96000,  138000, 138000, 200000, -29627, 0])
pos[3].append([138000, 200000, 138000, 200000, -29627, 0])


path = 	'/home/scanner/sndlhc/RUN0/b000131/vertexfiles/upstream25'
...
outputFile = r.TFile("vertex_selection.root","RECREATE")	
outputTree = r.TNtuple("vtx","Tree of vertices","quadrant:subquadrant:vID:flag:n:nin:nout:nseg:npl:ff")
  ...
  for subquad in range(4):
    ...
    for vtx in vertices:
      ...
      if flag == 1 or flag == 4:
        ...
        for itrack in range(ntracks):
          if vtx.Zpos(itrack)==0:
            ...
            nin = ntracks - nout
            outputTree.Fill(quad, subquad, vtx.ID(), flag, ntracks, nin, nout, 0, 0, 0)
            if nout>nin:
      ...
      #flag 0 study
        ...
        outputTree.Fill(quad, subquad, vtx.ID(), flag, ntracks, 0, ntracks, np.mean(nsegList), np.mean(nplList), np.mean(ffList))
