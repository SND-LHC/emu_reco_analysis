...
makescanset -set=21.0.0.0 -dzbase=195 -dz=-1350 -from_plate=$1 -to_plate=$2 -v=2 -reset

echo "Starting first align"

emalign -set=21.0.0.0 -new -v=2

cp b000021.0.0.0.align.ps plot_first_align/b000021.0.0.0.firstalign_$1_$2.ps
