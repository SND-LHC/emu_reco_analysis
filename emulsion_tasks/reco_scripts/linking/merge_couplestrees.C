...
void merge_couplestrees(int platenumber){
 const int brickID = 51;
 //histo file
 outputfile = new TFile(Form("/eos/user/o/onur/playground/b%0*i/p%0*i/%i.%i.0.0_merged.cp.root", 6, brickID, 3, platenumber, brickID, platenumber),"RECREATE"); 
 ...
 TString prepath(Form("/eos/user/o/onur/playground/b%0*i/p%0*i/%i.%i.",6, brickID, 3 , platenumber, brickID,platenumber));
